(function(global, factory) {
  ...
  */
  ...
  const messageSW = function messageSW(sw, data) {
  ...
  */
  const logger = (function() {
    ...
    const print = function print(method, args) {
      let _console2;
    ...
    const _arr = Object.keys(methodToColorMap);
  ...
  */
  ...
  const EventTargetShim =
    ...
    (function() {
      ...
      const _proto = EventTargetShim.prototype;
  ...
  */
  ...
  const urlsMatch = function urlsMatch(url1, url2) {
  ...
  */
  ...
  const Workbox =
    ...
    (function(_EventTargetShim) {
      ...
      const _proto = Workbox.prototype;
      _proto.register = _async(function(_temp) {
        const _this2 = this;

        const _ref = _temp === void 0 ? {} : _temp;
        const _ref$immediate = _ref.immediate;
        const immediate = _ref$immediate === void 0 ? false : _ref$immediate;
        ...
        return _invoke(
          ...
          function() {
            ...
            return _await(_this2._registerScript(), function(_this2$_registerScrip) {
              ...
              const waitingSW = _this2._registration.waiting;
...

              {
                ...
                const currentPageIsOutOfScope = function currentPageIsOutOfScope() {
