(this.workbox = this.workbox || {}),
  (this.workbox.backgroundSync = (function(t, e, s) {
    ...
    const i = 3;
    const n = 'workbox-background-sync';
    const a = 'requests';
    const r = 'queueName';
    class c {
      constructor(t) {
    ...
    class o {
      static async fromRequest(t) {
        ...
        t.method !== 'GET' && (e.body = await t.clone().arrayBuffer());
      ...
      constructor(t) {
        t.mode === 'navigate' && (t.mode = 'same-origin'), (this.o = t);
      }

      toObject() {
        const t = { ...this.o };
        return (t.headers = { ...this.o.headers }), t.body && (t.body = t.body.slice(0)), t;
      }
