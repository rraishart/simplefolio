  ...
  (this.workbox.strategies = (function(e, t, s, n, r) {
    ...
    class i {
      ...
      async makeRequest({ event: e, request: t }) {
        ...
        let n;
        let i = await s.cacheWrapper.match({
          cacheName: this.t,
          request: t,
          event: e,
          matchOptions: this.h,
    ...
    const u = {
      cacheWillUpdate: ({ response: e }) => (e.status === 200 || e.status === 0 ? e : null),
    };
    class a {
      constructor(e = {}) {
    ...
    class o {
      ...
      async makeRequest({ event: e, request: t }) {
        ...
        let i;
        let h = await s.cacheWrapper.match({
          cacheName: this.t,
          request: t,
          event: e,
          matchOptions: this.h,
    ...
    const w = q('cacheFirst');
    const p = q('cacheOnly');
    const v = q('networkFirst');
    const y = q('networkOnly');
    const m = q('staleWhileRevalidate');
    return (
      (e.CacheFirst = i),
      (e.CacheOnly = h),
      (e.NetworkFirst = a),
