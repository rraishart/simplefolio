  ...
  (this.workbox.expiration = (function(t, e, s, i, a, n) {
    ...
    class o {
      ...
      async setTimestamp(t, e) {
        (t = r(t)), await this.s.put(c, { url: t, timestamp: e, cacheName: this.t, id: this.h(t) });
      }
    ...
    class u {
      ...
      async expireEntries() {
        ...
        const e = await this.m.expireEntries(t, this.l);
        const s = await caches.open(this.t);
    ...
    return (
      ...
      (t.Plugin = class {
        ...
        N(t) {
          if (!this.p) return !0;
          const e = this._(t);
          return e === null || e >= Date.now() - 1e3 * this.p;
        }
