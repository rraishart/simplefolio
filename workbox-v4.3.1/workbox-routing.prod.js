  ...
  (this.workbox.routing = (function(t, e, r) {
      ...
      constructor(t, e, r) {
        super(
          ({ url: e }) => {
            ...
            return r ? (e.origin !== location.origin && r.index !== 0 ? null : r.slice(1)) : null;
          },
          e,
          r
        );
    ...
    class c {
      ...
      addFetchListener() {
        self.addEventListener('fetch', t => {
          const { request: e } = t;
          const r = this.handleRequest({ request: e, event: t });
          r && t.respondWith(r);
        });
      }
      ...
      handleRequest({ request: t, event: e }) {
        ...
        let s;
        const { params: n, route: o } = this.findMatchingRoute({ url: r, request: t, event: e });
        let i = o && o.handler;
        if ((!i && this.u && (i = this.u), i)) {
          ...
          return s && this.h && (s = s.catch(t => this.h.handle({ url: r, event: e, err: t }))), s;
        }
      }
      ...
      findMatchingRoute({ url: t, request: e, event: r }) {
        ...
        for (const n of s) {
          let s;
          const o = n.match({ url: t, request: e, event: r });
          if (o)
            return (
    ...
    return (
      ...
      (t.registerRoute = (t, e, s = 'GET') => {
        ...
        else if (typeof t === 'function') n = new o(t, e, s);
        else {
          if (!(t instanceof o))
